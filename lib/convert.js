...
exports.default = function (source, config) {
  ...
  (0, _hastml2.default)(html, function (match, tagFragment, offset) {
    if (tagFragment[0] === '<') {
      ...
      // ∴ tagFragment[tagFragment.length - 1] === '>'
